...
CREATE TABLE IF NOT EXISTS asignacion (
    ...
    fecha_inicio        DATE            NOT NULL,
    fecha_fin           DATE,
    estado              ENUM('PENDIENTE','EN_CURSO','FINALIZADO','SUSPENDIDO') NOT NULL DEFAULT 'EN_CURSO',
    motivo_cambio       TEXT,
...
CREATE TABLE IF NOT EXISTS tarea (
    ...
    comentario_tutor_empresa TEXT,
    valoracion_tutor_empresa TINYINT,
    id_validador        BIGINT,
    fecha_validacion    DATETIME,
    fecha_revision_empresa DATETIME,
    fecha_creacion      DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS falta_asistencia (
    ...
    estado              ENUM('INJUSTIFICADA','PENDIENTE_REVISION','VERIFICADA_EMPRESA','JUSTIFICADA') NOT NULL DEFAULT 'INJUSTIFICADA',
    observacion         TEXT,
    motivo_justificacion TEXT,
    horas_ausencia      DECIMAL(4,2),
    id_justificante     BIGINT,
    id_validado_por     BIGINT,
    comentario_verificacion_empresa TEXT,
    fecha_verificacion_empresa DATETIME,
    motivo_denegacion   TEXT,
    comentario_revision_centro TEXT,
    fecha_validacion    DATETIME,
    fecha_creacion      DATETIME        NOT NULL DEFAULT CURRENT_TIMESTAMP,
